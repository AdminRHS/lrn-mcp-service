...
var devToolHandlers = {
  async get_courses(args) {
    ...
    if (args.difficulty)
      params.append("difficulty", args.difficulty);
    if (args.all)
      params.append("all", "true");
    const response = await (0, import_node_fetch.default)(`${API_BASE_URL}/courses?${params}`, { headers: getHeaders() });
    if (!response.ok)
  ...
  async get_course(args) {
    const response = await (0, import_node_fetch.default)(`${API_BASE_URL}/courses/${args.courseId}`, { headers: getHeaders() });
    if (!response.ok)
      throw new Error(`HTTP ${response.status}: ${response.statusText}`);
    const data = await response.json();
    return { content: [{ type: "text", text: JSON.stringify(data, null, 2) }] };
  ...
  async create_course(args) {
        ...
        if (Array.isArray(mod.lessons)) {
          for (const lesson of mod.lessons) {
            if (typeof lesson === "string") {
              ...
              const lessonResp = await (0, import_node_fetch.default)(`${API_BASE_URL}/lessons/${lesson._id}`, {
                method: "PUT",
                headers: getHeaders(),
              ...
              const lessonResp = await (0, import_node_fetch.default)(`${API_BASE_URL}/lessons`, {
                method: "POST",
                headers: getHeaders(),
                body: JSON.stringify(lesson)
              });
    ...
    const response = await (0, import_node_fetch.default)(`${API_BASE_URL}/courses`, {
      method: "POST",
      headers: getHeaders(),
  ...
  async update_course(args) {
    ...
    const response = await (0, import_node_fetch.default)(`${API_BASE_URL}/courses/${courseId}`, {
      method: "PUT",
      headers: getHeaders(),
      body: JSON.stringify(courseData)
    });
  ...
  async get_lessons(args) {
    ...
    if (args.contentType)
      params.append("contentType", args.contentType);
    if (args.courseId)
      params.append("courseId", args.courseId);
    if (args.moduleId)
      params.append("moduleId", args.moduleId);
    if (args.sortBy)
      params.append("sortBy", args.sortBy);
    if (args.all)
      params.append("all", "true");
    const response = await (0, import_node_fetch.default)(`${API_BASE_URL}/lessons?${params}`, { headers: getHeaders() });
    if (!response.ok)
      throw new Error(`HTTP ${response.status}: ${response.statusText}`);
    const data = await response.json();
    return { content: [{ type: "text", text: JSON.stringify(data, null, 2) }] };
  ...
  async get_lesson(args) {
    const response = await (0, import_node_fetch.default)(`${API_BASE_URL}/lessons/${args.lessonId}`, { headers: getHeaders() });
    if (!response.ok)
      throw new Error(`HTTP ${response.status}: ${response.statusText}`);
    const data = await response.json();
    return { content: [{ type: "text", text: JSON.stringify(data, null, 2) }] };
  ...
  async create_lesson(args) {
    ...
    const response = await (0, import_node_fetch.default)(`${API_BASE_URL}/lessons`, {
      method: "POST",
      headers: getHeaders(),
  ...
  async update_lesson(args) {
    ...
    const response = await (0, import_node_fetch.default)(`${API_BASE_URL}/lessons/${lessonId}`, {
      method: "PUT",
      headers: getHeaders(),
      body: JSON.stringify(lessonData)
    });
  ...
  async get_professions() {
    const response = await (0, import_node_fetch.default)(`${API_BASE_URL_PROFESSIONS}/profession`, { headers: getHeaders() });
    if (!response.ok)
      throw new Error(`HTTP ${response.status}: ${response.statusText}`);
    const data = await response.json();
    return { content: [{ type: "text", text: JSON.stringify(data, null, 2) }] };
...
var API_BASE_URL = "https://lrn.oa-y.com/api-tokens";
var API_BASE_URL_PROFESSIONS = "https://libdev.anyemp.com/api";
...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
  ...
  if (!devToolHandlers[name]) {
    return { content: [{ type: "text", text: `Unknown tool: ${name}` }], isError: true };
  }
  try {
    return await devToolHandlers[name](args);
  } catch (error) {
...
async function main() {
  ...
  console.error("LRN MCP Server started on stdio");
}
main().catch((error) => {
